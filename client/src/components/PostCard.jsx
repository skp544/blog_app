...
const PostCard = ({ post }) => {
  return (
    <div className="group relative h-[300px] w-full overflow-hidden rounded-lg border border-teal-500 transition-all hover:border-2 sm:w-[330px]">
      <Link to={`/post/${post.slug}`}>
        <img
          src={post.postImage}
          alt="post cover"
          className="z-20 h-[160px] w-full object-cover transition-all duration-300 group-hover:h-[200px]"
        />
      </Link>
